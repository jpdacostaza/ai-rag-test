...
async def pipeline_inlet(request: dict = Body(...), api_key: str = Depends(verify_api_key)):
...
async def pipeline_outlet(request: dict = Body(...), api_key: str = Depends(verify_api_key)):

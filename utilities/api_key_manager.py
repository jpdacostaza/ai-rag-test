...
class APIKeyManager:
    ...
    def _create_empty_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "users": {},
            "environments": {
                "development": {"api_key": "", "base_url": "http://localhost:3000"},
                "production": {"api_key": "", "base_url": "https://your-openwebui-domain.com"},
            },
        }
    ...
    def add_environment_key(self, env_name: str, api_key: str, base_url: str) -> bool:
        ...
        Returns:
            True if saved successfully
        """
        self.keys_data["environments"][env_name] = {"api_key": api_key, "base_url": base_url}
        return self.save_keys()

    def set_default_key(
        self, api_key: str, base_url: str = "http://localhost:3000", description: str = "Default OpenWebUI instance"
    ) -> bool:
        """
        ...
        Returns:
            True if saved successfully
        """
        self.keys_data["default"] = {"api_key": api_key, "base_url": base_url, "description": description}
        return self.save_keys()
...
def setup_api_keys_interactive():
    ...
    while True:
        ...
        if choice == "1":
            ...
            description = (
                input("Enter description [Default OpenWebUI instance]: ").strip() or "Default OpenWebUI instance"
            )

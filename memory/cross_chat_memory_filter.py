            ...
            if self.valves.enable_memory_injection and latest_message and messages:
                try:
                    ...
                    if enhanced_messages and len(enhanced_messages) > len(messages):
                        ...
                        if self.valves.debug_mode:
                            print(f"[Cross-Chat Memory] Injected global memory, message count: {len(enhanced_messages)}")
    ...
    def _store_user_information(self, user_message: str, user_id: str):
        ...
        try:
            ...
            user_info_keywords = [
                ...
                "my job", "my profession", "i like", "i love", "i hate", 
                "i prefer", "remember that", "note that", "important:",

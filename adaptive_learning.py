...
class ConversationAnalyzer:
    ...
    async def analyze_interaction(self, user_id: str, conversation_id: str, 
                                ...
                                response_time: float, tools_used: Optional[List[str]]) -> Optional[InteractionMetrics]:
    ...
    async def _extract_topics(self, text: str) -> List[str]:
        ...
        common_topics = [
            "programming", "python", "javascript", "web development", "AI", "machine learning",
            "data science", "databases", "API", "deployment", "debugging", "testing",
            "weather", "news", "calculations", "research", "writing", "analysis"
        ]
    ...
    def _count_follow_up_indicators(self, message: str) -> int:
        ...
        follow_up_indicators = ["?", "how", "what", "why", "when", "where", "can you", "please explain"]
        message_lower = message.lower()
...
class AdaptiveLearningSystem:
    ...
    async def process_interaction(self, user_id: str, conversation_id: str,
                                user_message: str, assistant_response: str,
                                response_time: float, tools_used: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            await self._check_knowledge_expansion(user_id, metrics, user_message, assistant_response)
    ...
    async def get_user_insights(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            recent_metrics = list(self.learning_metrics[user_id])[-10:]  # Last 10 interactions
            ...
            return {
                ...
                "user_id": user_id,
                "insights": {
                    "top_topics": dict(sorted(user_data.get("topic_preferences", {}).items(), 
                                            key=lambda x: x[1], reverse=True)[:5]),
                    "preferred_tools": dict(sorted(user_data.get("tool_preferences", {}).items(), 
                                                 key=lambda x: x[1], reverse=True)[:5]),

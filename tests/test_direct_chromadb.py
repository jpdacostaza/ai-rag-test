...
def test_direct_chromadb_storage():
    ...
    test_content = (
        "My name is David and I am a machine learning engineer at AITech. I specialize in deep learning and PyTorch."
    )
    ...
    files = {"file": ("memory.txt", test_content, "text/plain")}
    data = {"user_id": user_id, "description": "Memory content for testing"}
    ...
    for query in test_queries:
        print(f"\n🔍 Testing query: '{query}'")
        retrieval_data = {"user_id": user_id, "query": query, "limit": 5, "threshold": 0.1}

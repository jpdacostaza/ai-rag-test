...
async def test_web_search():
    ...
    print(f"[SEARCH] Testing search for: {test_query}")
    ...
    try:
        ...
        if "Live web search temporarily unavailable" in result:
            print("\n[WARN]  Web search is using fallback mode - no real web data")
        elif "Real-time information" in result and "Note:" in result:
            print("\n[WARN]  Web search returned generic fallback response")
        else:
            print("\n[OK] Web search appears to be working")

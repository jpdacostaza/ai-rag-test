...
def test_simple_memory_storage():
    ...
    test_content = (
        "My name is Charlie and I am a software engineer at TechStart. I enjoy coding in JavaScript and React."
    )
    ...
    try:
        storage_response = requests.post(
            f"{BACKEND_URL}/api/learning/process_interaction", json=storage_data, headers=headers, timeout=10
        )

...
class CacheMemoryIntegrationTest:
    ...
    def test_system_prompt_cache_invalidation(self):
        ...
        if stats_after["cache_counts"]["chat"] == 0:
            ...
            print(
                f"❌ Chat cache not properly cleared: {stats_after['cache_counts']['chat']} entries remain"
            )
    ...
    def test_memory_integration(self):
        ...
        for i, message in enumerate(conversation, 1):
            ...
            if cached_response:
                ...
                if history_length > 0:
                    print(
                        f"📚 Retrieved {history_length} previous messages from memory"
                    )
    ...
    def test_performance_with_logging(self):
        ...
        for i in range(num_operations):
            ...
            response = (
                f"Response {i}: This is a test response for performance evaluation."
            )
    ...
    def show_final_statistics(self):
        ...
        if total_requests > 0:
            ...
            print(
                f"   Cache efficiency: {(self.test_stats['cache_hits']/self.test_stats['cache_sets'])*100:.1f}%"
            )
    ...
    def run_comprehensive_test(self):
        ...
        try:
            ...
            print(
                "📄 Detailed results saved to: comprehensive_cache_memory_test_results.json"
            )
            return True

...
def print_configuration_guide():
    ...
    print("\n📋 Current Status:")
    print("   ✅ Memory API: Running (localhost:8001)")
    print("   ✅ Pipelines Service: Running (localhost:9099)")
    print("   ✅ Memory Pipeline: Loaded globally")
    ...
    print("\n2. 🔄 Full System Restart (if needed):")
    ...
    print("   • Open a new chat with llama3.2:3b")

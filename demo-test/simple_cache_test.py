...
def test_cache_manager():
    ...
    try:
        ...
        print("   JSON cache attempt: {result}")
        ...
        if not chat_exists and other_exists:
            ...
            print("❌ FAIL: Chat exists: {chat_exists}, Other exists: {other_exists}")
            return False
        ...
        print("📄 Results saved to: cache_test_results.json")
        return True

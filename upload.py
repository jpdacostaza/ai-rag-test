...
from error_handler import get_user_friendly_message, log_error
...
async def upload_document(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=get_user_friendly_message(e, "upload")
        )
...
async def search_documents(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=get_user_friendly_message(e, "search")
        )
